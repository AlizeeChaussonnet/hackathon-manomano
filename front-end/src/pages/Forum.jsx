        ...
        <div className=" flex items-center justify-between pb-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="lg:ml-40 ml-10 space-x-8">
              <button className="button-forum">New Topic</button>
              <button className="button-forum">Create</button>
            </div>
          </div>
        </div>
        <div>
            ...
            <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                  ...
                  <tr>
                    ...
                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                      <span className="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                        ...
                        ></span>
                        <span className="relative">Activ</span>
                      </span>
                    </td>
                  </tr>
                  <tr>
              ...
              <div className="px-5 py-5 bg-white border-t flex flex-col xs:flex-row items-center xs:justify-between          ">
                <span className="text-xs xs:text-sm text-gray-900">
                  Showing 3 Entries related to your product
                </span>
                <div className="inline-flex mt-2 xs:mt-0">
                  <button className="button-forum">Prev</button>
                  &nbsp; &nbsp;
                  <button className="button-forum">Next</button>
                </div>
              </div>
            </div>
          </div>
